...
var address_creater = document.getElementById("user_address").innerHTML
...
function toggleButton() {
    ...
    if (cryptojs_key === null) {
        ...
        show_user_content_without_login(address_creater)

        etherscan_next = "https://etherscan.io/address/" + address_creater
...
function show_user_content_without_login(address_creater) {
    url = top_domain + '/get_user_owned_content_without_login' + "/?address2=" + encodeURIComponent(address_creater)
